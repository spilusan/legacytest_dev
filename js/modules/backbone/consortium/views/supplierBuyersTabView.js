...
define([
    ...
    'text!templates/consortium/tpl/supplierBuyersTab.html',
    'text!templates/consortium/tpl/supplierBuyerTable.html',
    'text!templates/consortium/tpl/supplierBuyerTableRow.html'
], function (
    $,
    _,
    Backbone,
    ...
    var View = Backbone.View.extend({
        ...
        showChildren: function (e) {
            ...
            var parentRow = $(e.target).closest('tr'),
                ...
                url = '/reports/data/consortium/suppliers/' + supplierId + '/buyers/' + buyerId + '/child-buyers?lowerdate=' + lowerDate + '&upperdate=' + upperDate;
