...
define([
    ...
    'text!templates/consortium/tpl/supplierBuyerPosTab.html',
    'text!templates/consortium/tpl/buyersPoTable.html',
    'text!templates/consortium/tpl/buyersPoTableRow.html',
], function (
    $,
    _,
    Backbone,
    ...
    var View = Backbone.View.extend({
        ...
        render: function (startDate, endDate, supplierId, buyerId, pageSize, pageNo) {
        ...
        renderMain: function (data) {
            var data = _.pick(data || {}, 'total_po_cnt', 'total_po_spend', 'buyer', 'supplier'),
        ...
        getTableData: function () {
            ...
            setTimeout(function () {
                $.getJSON(url, function (data) {
                        var mainData = _.pick(data, 'supplier', 'buyer', 'total_po_cnt', 'total_po_spend'),
