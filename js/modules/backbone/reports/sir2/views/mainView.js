define([
	...
	'../views/filtersView',
	'text!templates/reports/sir2/tpl/summary.html',
	'text!templates/reports/sir2/tpl/detailed.html',
	'text!templates/reports/sir2/tpl/unactioned.html',
	'text!templates/reports/sir2/tpl/unactionedrate.html',
	'text!templates/reports/sir2/tpl/onboard.html',
	'text!templates/reports/sir2/tpl/banner.html',
	'text!templates/reports/sir2/tpl/search.html',
	'text!templates/reports/sir2/tpl/profile.html',
	'text!templates/reports/sir2/tpl/contact.html',
	'text!templates/reports/sir2/tpl/rfq.html',
	'text!templates/reports/sir2/tpl/quotes.html',
	'text!templates/reports/sir2/tpl/po.html',
	'text!templates/reports/sir2/tpl/tpo.html',
	'text!templates/reports/sir2/tpl/customer.html',
	'text!templates/reports/sir2/tpl/market.html'
], function(
	$,
	_, 
	Backbone,
	...
	var sirView = Backbone.View.extend({
		...
		detailView: require('supplier/sir/detailView'),
		details: false,
		round: 0,
		debug: 0,
		...
		getSupplierData: function(){
			...
			this.supplierCollection.fetch({
				...
				complete: function(){
					...
					if(thisView.detailView == 1){
						thisView.details=true;
					}
		...
		renderDetails: function(){
			...
			try {
				$('.rfqCount.count').html(this.supplierCollection.models[0].attributes['enquiry-summary']['unactioned-rfq'].count);
				$('.rfqCount.rate').html(this.supplierCollection.models[0].attributes['enquiry-summary']['unactioned-rfq'].rate.toFixed(1)+"%");
    			} catch(err) {
    				/* Ignore error */
				}
