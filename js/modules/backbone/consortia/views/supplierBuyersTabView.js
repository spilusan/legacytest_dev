...
define([
    ...
    'text!templates/consortia/tpl/supplierBuyersTab.html',
    'text!templates/consortia/tpl/supplierBuyerTable.html',
    'text!templates/consortia/tpl/supplierBuyerTableRow.html'
], function (
    $,
    _,
    Backbone,
    ...
    var View = Backbone.View.extend({
        ...
        renderTableData: function (data) {
            ...
            tableData.drilldownEnabled = drilldownEnabled;
            ...
            if (data.buyers.length) {
                rowElements = data.buyers.map(function (x) {
        ...
        showChildren: function (e) {
            ...
            var parentRow = $(e.target).closest('tr'),
                ...
                buyerId = $(e.target).closest('tr').data('tnid'),
                url = '/reports/data/consortia/suppliers/' + supplierId + '/buyers/' + buyerId + '/child-buyers?lowerdate=' + lowerDate + '&upperdate=' + upperDate;

            this.loadChildren(url, buyerId, parentRow);
        },
