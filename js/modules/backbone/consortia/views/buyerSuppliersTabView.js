...
define([
    ...
    'text!templates/consortia/tpl/buyerSuppliersTab.html',
    'text!templates/consortia/tpl/buyerSuppliersTable.html',
    'text!templates/consortia/tpl/buyerSuppliersTableRow.html'
], function (
    $,
    _,
    Backbone,
    ...
    var View = Backbone.View.extend({
        ...
        showChildren: function (e) {
            ...
            var parentRow = $(e.target).closest('tr'),
                ...
                url = '/reports/data/consortia/buyers/' + buyerId + '/suppliers/' + supplierId + '/child-suppliers?lowerdate=' + lowerDate + '&upperdate=' + upperDate;
