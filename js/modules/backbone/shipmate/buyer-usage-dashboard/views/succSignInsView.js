define([
	...
	'../views/succSignInsViewRow',
	'../collections/collection',
	'text!templates/shipmate/buyer-usage-dashboard/tpl/succSignInsHead.html'
], function(
	$,
	_, 
	Backbone,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.collection.url = "/reports/data/appusage/drilldown/succ-sign-ins/"+this.buyer.byoOrgCode+'?range='+this.params.range;
		},
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/succ-sign-ins/"+this.buyer.byoOrgCode;
        },
