define([
	...
	'../views/verifiedUserAccountViewRow',
	'../collections/collection',
	'text!templates/shipmate/buyer-usage-dashboard/tpl/verifiedUserAccountHead.html'
], function(
	$,
	_, 
	Backbone,
	Hb,
	Modal,
	verifiedUserAccountViewRowView,
	collection,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.collection.url = "/reports/data/appusage/drilldown/verified-accounts/"+this.buyer.byoOrgCode;
		...
		renderItem: function(item) {
			var verifiedUserAccountViewRow = new verifiedUserAccountViewRowView({
				model: item
			});

			verifiedUserAccountViewRow.parent = this;

			$('table tbody').append(verifiedUserAccountViewRow.render().el);
		},
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/verified-accounts/"+this.buyer.byoOrgCode;
        },
