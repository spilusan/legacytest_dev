define([
	...
	'../views/activeTradingAccountsViewRow',
	'../collections/collection',
	'text!templates/shipmate/buyer-usage-dashboard/tpl/activeTradingAccountHead.html'
], function(
	$,
	_, 
	Backbone,
	Hb,
	Modal,
	activeTradingAccountViewRowView,
	collection,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.collection.url = "/reports/data/appusage/drilldown/active-trading-accounts/"+this.buyer.byoOrgCode;
		...
		renderItem: function(item) {
			var activeTradingAccountViewRow = new activeTradingAccountViewRowView({
				model: item
			});

			activeTradingAccountViewRow.parent = this;

			$('table tbody').append(activeTradingAccountViewRow.render().el);
		},
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/active-trading-accounts/"+this.buyer.byoOrgCode;
        },
