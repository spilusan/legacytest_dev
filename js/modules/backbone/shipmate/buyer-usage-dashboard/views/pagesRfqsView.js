define([
	...
	'../views/pagesRfqsRowView',
	'../collections/collection',
	'text!templates/shipmate/buyer-usage-dashboard/tpl/pagesRfqsHead.html'
], function(
	$,
	_, 
	Backbone,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.collection.url = "/reports/data/appusage/drilldown/pages-rfqs/"+this.buyer.byoOrgCode+'?range='+this.params.range;
		},
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/pages-rfqs/"+this.buyer.byoOrgCode+'?range='+this.params.range;
        },
