define([
	...
	'../views/searchEventsyRowView',
	'../collections/collection',
	'text!templates/shipmate/buyer-usage-dashboard/tpl/searchEventsHead.html'
], function(
	$,
	_, 
	Backbone,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.collection.url = "/reports/data/appusage/drilldown/search-events/"+this.buyer.byoOrgCode+'?range='+this.params.range;
		},
		...
		renderItem: function(item) {
			var succSignInsViewRow = new succSignInsViewRowView({
				model: item
			});
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/search-events/"+this.buyer.byoOrgCode+'?range='+this.params.range;
        },
