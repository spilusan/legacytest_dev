define([
	...
	'../views/searchImpressionsRowView',
	'../collections/collection',
	'text!templates/shipmate/buyer-usage-dashboard/tpl/searchImpressionsHead.html'
], function(
	$,
	_, 
	Backbone,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.collection.url = "/reports/data/appusage/drilldown/supplier-page-impressions/"+this.buyer.byoOrgCode+'?range='+this.params.range;
		},
		...
		renderItem: function(item) {
			var succSignInsViewRow = new searchImpressionsRowView({
				model: item
			});

			succSignInsViewRow.parent = this;

			$('table tbody').append(succSignInsViewRow.render().el);
		},
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/supplier-page-impressions/"+this.buyer.byoOrgCode+'?range='+this.params.range;
        },
