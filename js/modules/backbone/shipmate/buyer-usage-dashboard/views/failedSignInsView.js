define([
	...
	'../views/failedSignInsViewRow',
	'../collections/collection',
	'text!templates/shipmate/buyer-usage-dashboard/tpl/failedSignInsHead.html'
], function(
	$,
	_, 
	Backbone,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.collection.url = "/reports/data/appusage/drilldown/failed-sign-ins/"+this.buyer.byoOrgCode+'?range='+this.params.range;
		...
		renderItem: function(item) {
			var failedSignInsViewRow = new failedSignInsViewRowView({
				model: item
			});

			failedSignInsViewRow.parent = this;

			$('table tbody').append(failedSignInsViewRow.render().el);
		},
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/failed-sign-ins/"+this.buyer.byoOrgCode;
        },
