define([
	...
	'text!templates/shipmate/buyer-usage-dashboard/tpl/userActivityHead.html'
], function(
	$,
	_, 
	Backbone,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			this.collection = new collection();
         	this.collection.url = "/reports/data/appusage/drilldown/user-activity/"+this.buyer.byoOrgCode+'?range='+this.params.range+'&reportType='+this.params.reportType+'&excludeSM='+this.params.excludeSM;
		},
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/user-activity/"+this.buyer.byoOrgCode+'?range='+this.params.range+'&reportType='+this.params.reportType+'&excludeSM='+this.params.excludeSM;
        },
