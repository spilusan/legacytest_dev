define([
	...
	'../views/contactRequestsRowView',
	'../collections/collection',
	'text!templates/shipmate/buyer-usage-dashboard/tpl/contactRequestsHead.html'
], function(
	$,
	_, 
	Backbone,
	...
	var usageDashboardView = Backbone.View.extend({
		...
		initialize: function(){
			...
			this.collection.url = "/reports/data/appusage/drilldown/contact-requests/"+this.buyer.byoOrgCode+'?range='+this.params.range;
		},
		...
		renderItem: function(item) {
			var succSignInsViewRow = new contactRequestsRowView({
				model: item
			});
        ...
        exportReport: function(e){
        	...
        	location.href = "/reports/export/appusage/drilldown/contact-requests/"+this.buyer.byoOrgCode+'?range='+this.params.range;
        },
