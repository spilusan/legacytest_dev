	...
	receiveEvent: function(eventName, args) {
		...
		switch (eventName) {
			case 'load':
				...
				console.log(this.fileName, this.action, this.charSet, this.incBom);
...
if ( typeof define === 'function' && define.amd ) {
	define( ['jquery', 'libs/jquery.dataTables.min'], factory );
}
else if ( typeof exports === 'object' ) {
    // Node/CommonJS
    factory( require('jquery'), require('libs/jquery.dataTables.min') );
}
