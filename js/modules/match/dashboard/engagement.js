...
function draw (){
	...
	var data = [[
     	'Month' 
//     	, 'Tradenet RFQ'
//     	, 'Tradenet RFQ (actioned)'
     	, 'Tradenet RFQ (actioned rate)'
//     	, 'Tradenet PO'
     	, 'Tradenet PO (win rate)'
     	
//     	, 'Pages RFQ'
//     	, 'Pages RFQ (actioned)'
     	, 'Pages RFQ (actioned rate)'
//     	, 'Pages PO'
     	, 'Pages PO (win rate)'     	
	...
	for(var i=1; i<13; i++){
 		x = new Array();
 		x.push( getMonth(i) );
// 		x.push( typeof allData['TRADENET_ALL'][i] == 'undefined' ? 0:allData['TRADENET_ALL'][i]);
// 		x.push( typeof allData['TRADENET_ACTIONED'][i] == 'undefined' ? 0:allData['TRADENET_ACTIONED'][i]);
 		x.push( typeof allData['TRADENET_ACTIONED_RATE'][i] == 'undefined' ? 0:allData['TRADENET_ACTIONED_RATE'][i]);
// 		x.push( typeof allData['TRADENET_PO'][i] == 'undefined' ? 0:allData['TRADENET_PO'][i]);
 		x.push( typeof allData['TRADENET_PO_RATE'][i] == 'undefined' ? 0:allData['TRADENET_PO_RATE'][i]);
// 		x.push( typeof allData['PAGES_ALL'][i] == 'undefined' ? 0:allData['PAGES_ALL'][i]);
// 		x.push( typeof allData['PAGES_ACTIONED'][i] == 'undefined' ? 0:allData['PAGES_ACTIONED'][i]);
 		x.push( typeof allData['PAGES_ACTIONED_RATE'][i] == 'undefined' ? 0:allData['PAGES_ACTIONED_RATE'][i]);
// 		x.push( typeof allData['PAGES_PO'][i] == 'undefined' ? 0:allData['PAGES_PO'][i]);
 		x.push( typeof allData['PAGES_PO_RATE'][i] == 'undefined' ? 0:allData['PAGES_PO_RATE'][i]);
