...
class Consortium_BuyerRestController extends Myshipserv_Controller_RestController
{
    ...
    public function postAction()
    {
        ...
        if (($type === null || $lowerdate === null || $upperdate === null) && ($type !== 'consortia')) {
        ...
        switch ($type) {
            case 'consortia':
                return $this->_replyJson($reporService->forward('buyer-org/' . $buyerOrgId, []));
            case 'buyers':
                return $this->_replyJson($reporService->forward('buyer-org/' . $buyerOrgId . '/buyers', array('consortia-id' => $consortiaId, 'lowerdate' => $lowerdate, 'upperdate' => $upperdate)));
            case 'buyers-post':
                if ($byb === null) {
                ...
                return $this->_replyJson($reporService->forward('buyer-org/' .$buyerOrgId . '/buyers/' . (int)$byb . '/pos', array('consortia-id' => $consortiaId, 'lowerdate' => $lowerdate, 'upperdate' => $upperdate, 'pageNo' => $pageNo, 'pageSize' => $pageSize)));
            case 'child-buyers':
                if ($byb === null) {
                    return $this->_replyJsonError(new Myshipserv_Exception_JSONException("buyer branch parameter is missing or invalid, incomplete URL", 500), 500);
                }
                return $this->_replyJson($reporService->forward('buyer-org/' . $buyerOrgId . '/buyers/' . (int)$byb . '/child-buyers', array('consortia-id' => $consortiaId, 'lowerdate' => $lowerdate, 'upperdate' => $upperdate)));
            case 'suppliers':
                if ($byb === null) {
                    return $this->_replyJsonError(new Myshipserv_Exception_JSONException("buyer branch parameter is missing or invalid, incomplete URL", 500), 500);
                }
                return $this->_replyJson($reporService->forward('buyer-org/' . $buyerOrgId . '/buyers/' . (int)$byb . '/suppliers', array('consortia-id' => $consortiaId, 'lowerdate' => $lowerdate, 'upperdate' => $upperdate)));
            case 'suppliers-pos':
                if ($byb === null || $spb === null) {
                    return $this->_replyJsonError(new Myshipserv_Exception_JSONException("buyer branch parameter is missing or invalid, incomplete URL", 500), 500);
                }
                return $this->_replyJson($reporService->forward('buyer-org/' . $buyerOrgId . '/buyers/' . (int)$byb . '/suppliers/' . (int)$spb . '/pos', array('consortia-id' => $consortiaId, 'lowerdate' => $lowerdate, 'upperdate' => $upperdate, 'pageNo' => $pageNo, 'pageSize' => $pageSize)));
            case 'suppliers-child-suppliers':
                ...
                return $this->_replyJson($reporService->forward('buyer-org/' . $buyerOrgId . '/buyers/' . (int)$byb . '/suppliers/' . (int)$spb . '/child-suppliers', array('consortia-id' => $consortiaId, 'lowerdate' => $lowerdate, 'upperdate' => $upperdate)));
