<?php
/**
 * Controller actions for SPR Quality tab
 * Sample URL: /reports/data/supplier-performance-quality/:type?tnid=XXX&byb=XXX&period=XXX
 *
 * @author attilaolbrich
 *
 */
class Spr_QualityRestController extends Myshipserv_Controller_RestController
{
	...
	public function postAction()
	{
		...
		$reporService = Myshipserv_Spr_QualityGateway::getInstance();
