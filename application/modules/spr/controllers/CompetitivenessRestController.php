<?php
/**
 * Controller actions for SPR Competitiveness tab
 * Sample URL: /reports/data/supplier-performance-competitiveness/:type?tnid=XXX&byb=XXX&period=XXX
 *
 * @author attilaolbrich
 *
 */

class Spr_CompetitivenessRestController extends Myshipserv_Controller_RestController
{
	...
	public function postAction()
	{
		...
		$reporService = Myshipserv_Spr_CompetitivenessGateway::getInstance();
