<?php
/**
 * Controller actions for SPR Cycle tab
 * Sample URL: /reports/data/supplier-performance-order/:type?tnid=XXX&byb=XXX&period=XXX
 *
 * @author attilaolbrich
 *
 */
class Spr_CycleRestController extends Myshipserv_Controller_RestController
{
	...
	public function postAction()
	{
		...
		$reporService = Myshipserv_Spr_CycleGateway::getInstance();
		$reply = $reporService->getReport($type, $params);
		
		//Uncomment the part under, when it really uses report service, and dummy backend is removed
