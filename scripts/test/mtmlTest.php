...
class MtmlTest
{
	public static function run ()
	{
		...
		$xml1 = Mtml_RfqBuilder::testValid();
		//$xml2 = self::getXml2();
		//echo $xml1;
		//echo $xml2;
		//exit;
		$client->setRawData($xml1, 'text/xml');
...
class Mtml_RfqBuilder
{
	public static function testParams ()
	{
		$controlReference = "RequestForQuote:4325000";
		
		$references = new Mtml_Rfq_References($controlReference, 'Human ref');
		
		$partyBuyer = new Mtml_Rfq_PartyBuyer('Company name');
		$partyBuyer->setContactName('Contact name');
		$partyBuyer->setContactPhone('Contact phone');
		$partyBuyer->setContactEmail('Contact e-mail');
		
		$parties = new Mtml_Rfq_Parties($partyBuyer);
		$parties->setDeliveryPort('Delivery port');
		$parties->setVesselName('Vessel name');
		$parties->setVesselImo('Vessel IMO');
		...
		$lineItem->setPartNumber('Part type', 'Part code');
		$lineItem->setUom('uom');
		$lineItem->setComment('Line item comment');
		...
		$section = new Mtml_Rfq_Section();
		$section->setDepartmentType('departmentType');
		$section->setDescription('description');
		$section->setDrawingNumber('drawingNumber');
		$section->setManufacturer('manufacturer');
		$section->setModelNumber('modelNumber');
		$section->setName('name');
		$section->setSerialNumber('serialNumber');
		
		$lineItem->setSection($section);
		
		$lineItem->setComment('Comment 2');
		...
		foreach ($interchangeRfq->toXmlArr() as $xi)
		{
			echo $xi->toXml();
		}
	}
	...
	{
		$controlReference = "RequestForQuote:4325029";
	...
	public static function buildRfq ()
	{
		$controlReference = "RequestForQuote:4325029";
