<?php
class Myshipserv_NotificationManager_Email_BrandAuthApproved  extends Myshipserv_NotificationManager_Email_Abstract{
	...
	{
		return 'Your brand authorisation request was approved';
	}
	...
	public function getBody ()
	{
		...
		$bodyHtml = $view->render('email/approved-brand-auth.phtml');
