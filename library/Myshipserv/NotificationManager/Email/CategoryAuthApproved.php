<?php
class Myshipserv_NotificationManager_Email_CategoryAuthApproved  extends Myshipserv_NotificationManager_Email_Abstract{
	...
	{
		return 'ShipServ Pages: category listing request approved';
	}
	...
	public function getBody ()
	{
		...
		$bodyHtml = $view->render('email/approved-category-auth.phtml');
