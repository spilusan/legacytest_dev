...
class Myshipserv_NotificationManager_Email_Targetcustomers_Locked extends Myshipserv_NotificationManager_Email_Abstract
{
	private 
		$recipientUserId,
		$bybBranchCode,
...
public function getRecipients()
	...
	{
		return $this->buyerInfo['BYB_NAME'].' locked for Active Promotion.';  //TODO confirm title
	}
	...
	public function getBody ()
	{
		...
		$res = $view->render('email/Targetcustomers/order-sent-locked.phtml');
