...
class Myshipserv_NotificationManager_Email_Targetcustomers_Targeted extends Myshipserv_NotificationManager_Email_Abstract
{
	private 
		$recipientUserId,
		$bybBranchCode,
...
public function getRecipients()
	...
	{
		return $this->buyerInfo['BYB_NAME'].' added to Active Promotion list.'; 
	}
	...
	public function getBody ()
	{
		...
		$res = $view->render('email/Targetcustomers/buyer-targeted.phtml');
