...
class Myshipserv_NotificationManager_Email_GrantCompany extends Myshipserv_NotificationManager_Email_Abstract
{
	...
	{
		return 'Company membership request approved';
	}
	...
	public function getBody ()
	{
		...
		$res = $view->render('email/grant-company.phtml');
