...
*/
class Shipserv_Report_Usage_UserActivity
{
	protected $dataSet;
	...
	*/
	public function __construct($byo = null, $range = 36, $reportType = '', $excludeShipmate = false)
	{
		if ($byo === null) {
			...
			$this->dataSet = new Shipserv_Report_Usage_Data_UserActivity($byo, $range, $reportType, $excludeShipmate);
		}
	}
	...
	*/
	public function getResult()
	{
		...
		foreach ($records as $record) {
			array_push($result, new Shipserv_Report_Usage_Rec_UserActivity($record));
		}
