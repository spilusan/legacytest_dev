<?php
/**
*	Buyer Usage Dashboard, List of failed Sign Ins 
*/
class Shipserv_Report_Usage_FailedSignIns
{
	protected $dataSet;
	...
	*/
	public function __construct($byo = null, $range = 36)
	{
		if ($byo === null) {
			...
			$this->dataSet = new Shipserv_Report_Usage_Data_FailedSignIns($byo, $range);
		}
	}
	...
	*/
	public function getResult()
	{
		...
		foreach ($records as $record) {
			array_push($result, new Shipserv_Report_Usage_Rec_FailedSignIns($record));
		}
