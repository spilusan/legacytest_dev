<?php
/**
*	Buyer Usage Dashboard, List of Sign Ins (Successful, ....)
*/
class Shipserv_Report_Usage_SignIns
{
	protected $dataSet;
	...
	*/
	public function __construct($byo = null, $range = 36)
	{
		if ($byo === null) {
			...
			$this->dataSet = new Shipserv_Report_Usage_Data_SignIns($byo, $range);
		}
	}
	...
	*/
	public function getResult()
	{
		...
		foreach ($records as $record) {
			array_push($result, new Shipserv_Report_Usage_Rec_SignIns($record));
		}
