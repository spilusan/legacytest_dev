...
*/
class Shipserv_Report_Usage_VerifiedAccounts
{
	protected $dataSet;
	...
	*/
	public function __construct($byo = null)
	{
		if ($byo === null) {
			...
			$this->dataSet = new Shipserv_Report_Usage_Data_VerifiedAccounts($byo);
		}
	}
	...
	*/
	public function getResult()
	{
		...
		foreach ($records as $record) {
			array_push($result, new Shipserv_Report_Usage_Rec_VerifiedAccounts($record));
		}
