<?php
/**
*	Buyer Usage Dashboard, list of verified accounts
*/
class Shipserv_Report_Usage_NonVerifiedAccounts
{
	protected $dataSet;
	...
	*/
	public function __construct($byo = null)
	{
		if ($byo === null) {
			...
			$this->dataSet = new Shipserv_Report_Usage_Data_NonVerifiedAccounts($byo);
		}
	}
	...
	*/
	public function getResult()
	{
		...
		foreach ($records as $record) {
			array_push($result, new Shipserv_Report_Usage_Rec_NonVerifiedAccounts($record));
		}
