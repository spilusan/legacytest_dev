 ...
 */
class ShipservCodeSniffer_Sniffs_Formatting_DisallowMultipleStatementsSniff implements PHP_CodeSniffer_Sniff
{
    /**
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        if ($tokens[$prev]['line'] === $tokens[$stackPtr]['line'] && !substr($phpcsFile->getFilename(), -6) === '.phtml') {
