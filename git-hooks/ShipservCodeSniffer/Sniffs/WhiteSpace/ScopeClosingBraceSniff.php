...
if (class_exists('PEAR_Sniffs_WhiteSpace_ScopeClosingBraceSniff', true) === false) {
    throw new PHP_CodeSniffer_Exception('Class PEAR_Sniffs_WhiteSpace_ScopeClosingBraceSniff not found');
}

class ShipservCodeSniffer_Sniffs_WhiteSpace_ScopeClosingBraceSniff extends PEAR_Sniffs_WhiteSpace_ScopeClosingBraceSniff
{
    ...
    public function process(PHP_CodeSniffer_File $phpcsFile, $stackPtr)
    {
        ...
        /*ShipServ modif: this rule does apply very badly for phtml files. let's exclude it*/
        if (substr($phpcsFile->getFilename(), -6) !== '.phtml' && $tokens[$lastContent]['line'] === $tokens[$scopeEnd]['line']) {
